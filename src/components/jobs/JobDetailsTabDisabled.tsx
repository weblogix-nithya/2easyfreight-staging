...
import PaginationTableDisabled from "components/table/PaginationTableDisabled";
...
const JobDetailsTab = ({
  ...
  return (
    <Box mt={10}>
      {/* Basic fields */}
      {isAdmin && [1, 2, 3, 4, 5].includes(Number(job.job_status_id)) ? (
        <Box mb="16px">
          <CustomInputField
            isSelect={true}
        ...
        {isAdmin && [1, 2, 3, 4, 5].includes(Number(job.job_status_id)) ? (
          ...
          <>
            ...
            <Flex alignItems="center" mb={"16px"}>
              <SimpleGrid width="200px" columns={{ sm: 1 }}>
                <GridItem>
                  <Text fontSize="sm">Base Notes</Text>
                </GridItem>
              </SimpleGrid>
              <Text fontSize="sm" width={"50%"}>
                {job.base_notes ? job.base_notes : "-"}
              </Text>
            </Flex>
          </>
        )}
            ...
            <Box>
              <Flex alignItems="center" width="100%" pt={7}>
                <SimpleGrid columns={{ sm: 1 }} width="100%">
                  ...
                  <GridItem>
                    <RadioGroup
                      isDisabled={!isAdmin || job.job_status_id == 6}
